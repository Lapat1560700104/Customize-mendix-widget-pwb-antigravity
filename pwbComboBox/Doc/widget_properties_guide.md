...
| `selectAllText` | **Select All Text** | String | `เลือกทั้งหมด` | ข้อความบนปุ่มกดเลือกรายการทั้งหมด | **การแปลภาษา**: รองรับภาษาไทย/อังกฤษ หรือปุ่มข้อความแบบมีไอคอนประกอบ |
| `deselectAllText` | **Deselect All Text** | String | `ล้างทั้งหมด` | ข้อความบนปุ่มกดล้างรายการที่เลือกทั้งหมดออก | **การแปลภาษา**: รองรับภาษาไทย/อังกฤษ หรือปุ่มข้อความแบบมีไอคอนประกอบ |
...
| :--- | :--- | :--- | :---: | :--- | :--- |
| `placeholder` | **Placeholder Text** | String | `Search...` | ข้อความตัวอย่างลอยในช่องอินพุตเมื่อยังไม่มีผลการเลือก | แนะนำผู้ใช้อย่างนุ่มนวลว่าสามารถพิมพ์สืบค้นสิ่งใดได้ในช่องนี้ |
...
| Property Key | Caption (ชื่อใน Mendix) | Type (ประเภท) | Default | คำอธิบายและความสำคัญ | ผลลัพธ์และผลกระทบต่อหน้าตา / ฟังก์ชันการใช้งาน |
| :--- | :--- | :--- | :---: | :--- | :--- |
| `noOptionsMessage` | **No Options Alert** | String | `ไม่พบตัวเลือก` | ข้อความแจ้งเตือนสีเทาอ่อนลอยตรงกลาง Dropdown เมื่อการค้นหาไม่พบรายการใดๆ | **การสื่อสารผู้ใช้**: แนะนำให้ผู้ใช้ทราบว่าไม่มีข้อมูลตรงกับคำค้นหา ปรับปรุงข้อความให้เข้ากับภาษาท้องถิ่นได้ |
| `loadingMessage` | **Loading Text** | String | `กำลังโหลด...` | ข้อความที่จะโชว์ให้ผู้ใช้ทราบขณะรอ Mendix ดึงข้อมูลตัวเลือกจากระบบฐานข้อมูล | **ลดการกังวลของผู้ใช้**: สื่อสารว่าระบบกำลังทำงานอยู่ ไม่ได้แอปพลิเคชันค้างหรือกดไม่ติด |
| `clearButtonTitle` | **Clear Button Accessibility Title**| String | `ล้างค่า` | ป้ายชื่อคำอธิบาย (ARIA Label) ของปุ่มกากบาทเคลียร์ค่าทั้งหมดบนช่องค้นหา | **มาตรฐานสากล WCAG**: ปรากฏเป็นข้อความคำใบ้เมื่อเอาเมาส์ชี้ และถูกอ่านออกเสียงโดยระบบ Screen Reader ช่วยเหลือผู้ทุพพลภาพทางสายตา |
...
| `customValidationMessage`| **Custom Validation Message**| String | `Violates...` | ข้อความเตือนที่จะปรากฏด้านล่างฟิลด์กรอกเมื่อสูตรการตรวจสอบด้านบนตอบออกมาเป็นค่าเท็จ (False) | **การสื่อสารข้อขัดแย้งของข้อมูล**: ชี้แจงข้อห้ามเฉพาะเจาะจงให้ผู้ใช้เข้าใจเหตุผลที่ไม่สามารถส่งข้อมูลที่เลือกนั้นๆ ได้ |
